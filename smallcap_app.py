...
SEKTOR = {
    "TAMBANG": ["DOID.JK","HRUM.JK","RAJA.JK","BRMS.JK","ELSA.JK","DEWA.JK"],
    "ENERGI": ["WIKA.JK","PTPP.JK","RAJA.JK","INDY.JK"],
    "KONSUMER": ["GGRM.JK","CMRY.JK","ROTI.JK","ULTJ.JK","KEJU.JK","CLEO.JK"],
    "PROPERTI": ["BSDE.JK","ASRI.JK","DMAS.JK","CTRA.JK","KIJA.JK"],
    "TEKNOLOGI": ["BUKA.JK","EMTK.JK","DCII.JK","MTDL.JK","WIFI.JK"],
    "INDUSTRI": ["ARNA.JK","TOTO.JK","JPFA.JK","MAIN.JK","SRTG.JK"],
    "KESEHATAN": ["MIKA.JK","HEAL.JK","PRDA.JK","SILO.JK"],
    "RITEL": ["MAPA.JK","RALS.JK","LPPF.JK","ERAA.JK","ACES.JK"],
    "FINANSIAL": ["BFIN.JK","BTPS.JK","ADMF.JK","PNLF.JK"],
    "INFRA": ["JSMR.JK","META.JK","CASS.JK","TOWR.JK"],
}
...
with c1:
    st.markdown("# 💎 Small Cap Scanner")
    st.caption("Saham Small/Mid Cap · Proteksi Likuiditas + Anti-Gorengan")
...
st.warning("""⚠️ **PERINGATAN SMALL CAP** — Saham small cap berisiko TINGGI: harga sangat volatil,
likuiditas rendah (susah jual), dan rawan dimainkan bandar ("digoreng"). Scanner ini sudah
menyaring saham tidak likuid & rawan goreng (tag 🔥 RAWAN GORENG / 💧 KURANG LIKUID → AVOID),
tapi tetap WAJIB pakai stop loss & position size kecil. Hanya pakai uang yang siap hilang.""")
